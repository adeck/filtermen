import polarization.kernels.InterpolationInt

import scalapipe.kernels._
import scalapipe.dsl._

object InterpolationIntTest extends App {
	...
	val Random = new Kernel("Random") {
		...
		val app = new Application {
			...
			val iterations = (imgHeight + 2) * (imgWidth + 2) * 5
		...
		app.emit("InterpolationIntTest100")
